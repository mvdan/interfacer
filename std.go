...
var ifaces = map[string]string{
	...
	"Header() (*net.dnsRR_Header); Walk(func(v interface{}, name string, tag string) (ok bool)) (bool)":               "net.dnsRR",
	"Network() (string); String() (string)":                                                                           "net.sockaddr",
	...
	"End() (go/token.Pos); Pos() (go/token.Pos)":                                                                                     "go/ast.Stmt",
	...
	"Replace(string) (string); WriteString(io.Writer, string) (int, error)":                                                                         "strings.replacer",
	...
	"MAC([]byte, []byte, []byte, []byte) ([]byte); Size() (int)":                                                                          "crypto/tls.macFunction",
	...
	"AddressSize() (int); Next() (*debug/dwarf.Entry, error); Seek(debug/dwarf.Offset) ()":                                                "debug/dwarf.typeReader",
	"Raw() ([]byte)":                                                         "debug/macho.Load",
	"Kind() (go/constant.Kind); String() (string)":                           "go/constant.Value",
	...
	"Copy() (text/template/parse.Node); Position() (text/template/parse.Pos); String() (string); Type() (text/template/parse.NodeType)":        "text/template/parse.Node",
}

var funcs = map[string]string{
	"(byte) (error)":                                                  "io.ByteWriter.WriteByte",
	"(io.Reader) (int64, error)":                                      "io.ReaderFrom.ReadFrom",
	"(int64, int) (int64, error)":                                     "io.WriteSeeker.Seek",
	"([]byte) (int, error)":                                           "io.Writer.Write",
	"([]byte, int64) (int, error)":                                    "io.WriterAt.WriteAt",
	"(io.Writer) (int64, error)":                                      "io.WriterTo.WriteTo",
	"(fmt.State, rune) ()":                                            "fmt.Formatter.Format",
	"(bool, func(rune) bool) ([]byte, error)":                         "fmt.ScanState.Token",
	"(fmt.ScanState, rune) (error)":                                   "fmt.Scanner.Scan",
	"(int) (bool)":                                                    "fmt.State.Flag",
	"([]byte) (int, net.Addr, error)":                                 "net.PacketConn.ReadFrom",
	"([]byte, net.Addr) (int, error)":                                 "net.PacketConn.WriteTo",
	"(time.Time) (error)":                                             "net.dnsConn.SetWriteDeadline",
	"(func(v interface{}, name string, tag string) (ok bool)) (bool)": "net.dnsRR.Walk",
	"(string) (error)":                                                "flag.Value.Set",
	"([]byte) ([]byte)":                                               "hash.Hash64.Sum",
	"(int, int) (bool)":                                               "sort.Interface.Less",
	"(int, int) ()":                                                   "sort.Interface.Swap",
	"([]byte, bool) (int, []byte, error)":                             "bufio.SplitFunc",
	"(int, int) (image/color.Color)":                                  "image.PalettedImage.At",
	"(int, int) (uint8)":                                              "image.PalettedImage.ColorIndexAt",
	"(io.Reader, []byte, crypto.DecrypterOpts) ([]byte, error)":       "crypto.Decrypter.Decrypt",
	"(io.Reader, []byte, crypto.SignerOpts) ([]byte, error)":          "crypto.Signer.Sign",
	"(string, reflect.Value) (bool)":                                  "go/ast.FieldFilter",
	"(string) (bool)":                                                 "go/ast.Filter",
	"(map[string]*go/ast.Object, string) (*go/ast.Object, error)":     "go/ast.Importer",
	...
	"(interface{}) (error)":                                           "net/rpc.ServerCodec.ReadRequestBody",
	...
	"(int) (reflect.StructField)":                                     "reflect.Type.Field",
	"([]int) (reflect.StructField)":                                   "reflect.Type.FieldByIndex",
	"(string) (reflect.StructField, bool)":                            "reflect.Type.FieldByName",
	"(func(string) bool) (reflect.StructField, bool)":                 "reflect.Type.FieldByNameFunc",
	"(reflect.Type) (bool)":                                           "reflect.Type.Implements",
	"(int) (reflect.Method)":                                          "reflect.Type.Method",
	"(string) (reflect.Method, bool)":                                 "reflect.Type.MethodByName",
	"(int) (reflect.Type)":                                            "reflect.Type.Out",
	"(string) (string)":                                               "strings.replacer.Replace",
	"(io.Writer, string) (int, error)":                                "strings.replacer.WriteString",
	"([]interface{}) ()":                                              "testing.TB.Skip",
	"(string, []interface{}) ()":                                      "testing.TB.Skipf",
	"([]byte) (error)":                                                "encoding.TextUnmarshaler.UnmarshalText",
	"(string) (*go/types.Package, error)":                             "go/types.Importer.Import",
	"(*go/types.Package) (string)":                                    "go/types.Qualifier",
	"([]*go/types.Var) ([]int64)":                                     "go/types.Sizes.Offsetsof",
	"(go/types.Type) (int64)":                                         "go/types.Sizes.Sizeof",
	"(*go/types.operand, int) ()":                                     "go/types.getter",
	"(*net/url.URL) ([]*net/http.Cookie)":                             "net/http.CookieJar.Cookies",
	"(*net/url.URL, []*net/http.Cookie) ()":                           "net/http.CookieJar.SetCookies",
	"(int) ([]os.FileInfo, error)":                                    "net/http.File.Readdir",
	"(string) (net/http.File, error)":                                 "net/http.FileSystem.Open",
	"(net/http.ResponseWriter, *net/http.Request) ()":                 "net/http.HandlerFunc",
	"(int) ()": "net/http.ResponseWriter.WriteHeader",
	"(*net/http.Request) (*net/http.Response, error)": "net/http.RoundTripper.RoundTrip",
	"([]byte, bool) ([]byte, error)":                  "net/smtp.Auth.Next",
	"(*net/smtp.ServerInfo) (string, []byte, error)":  "net/smtp.Auth.Start",
	"(int64) ()": "math/rand.Source.Seed",
	"(string) (*crypto/tls.ClientSessionState, bool)":                        "crypto/tls.ClientSessionCache.Get",
	"(string, *crypto/tls.ClientSessionState) ()":                            "crypto/tls.ClientSessionCache.Put",
	"([]byte, []byte, []byte, []byte) ([]byte)":                              "crypto/tls.macFunction.MAC",
	...
	"(int, int, image/color.Color) ()":                                       "image/draw.Image.Set",
	"(image/color.Palette, image.Image) (image/color.Palette)":               "image/draw.Quantizer.Quantize",
	"(io.Writer) (io.WriteCloser, error)":                                    "archive/zip.Compressor",
	"(io.Reader) (io.ReadCloser)":                                            "archive/zip.Decompressor",
	"(debug/dwarf.Offset) ()":                                                "debug/dwarf.typeReader.Seek",
	"(string) (io.ReadCloser, error)":                                        "go/importer.Lookup",
	"(image/color.Color) (image/color.Color)":                                "image/color.Model.Convert",
	"(*encoding/gob.decoderState, reflect.Value, int, error) (bool)":         "encoding/gob.decHelper",
	"(*encoding/gob.decInstr, *encoding/gob.decoderState, reflect.Value) ()": "encoding/gob.decOp",
	"(*encoding/gob.encoderState, reflect.Value) (bool)":                     "encoding/gob.encHelper",
	"(*encoding/gob.encInstr, *encoding/gob.encoderState, reflect.Value) ()": "encoding/gob.encOp",
	...
	"(io.Reader, []byte) (error)":                                            "compress/zlib.Resetter.Reset",
	"([]byte, []byte, []byte, []byte) ([]byte, error)":                       "crypto/cipher.AEAD.Open",
	"([]byte, []byte) ()":                                                    "crypto/cipher.Stream.XORKeyStream",
	"(string, os.FileInfo, error) (error)":                                   "path/filepath.WalkFunc",
	"(*math/rand.Rand, int) (reflect.Value)":                                 "testing/quick.Generator.Generate",
	"(interface{}) ()":                                                       "container/heap.Interface.Push",
	...
	"([]byte) (*math/big.Int, *math/big.Int)":                                                     "crypto/elliptic.Curve.ScalarBaseMult",
	"(*math/big.Int, *math/big.Int, []byte) (*math/big.Int, *math/big.Int)":                       "crypto/elliptic.Curve.ScalarMult",
	"([]byte, uint16) ()":                                                                         "encoding/binary.ByteOrder.PutUint16",
	"([]byte, uint32) ()":                                                                         "encoding/binary.ByteOrder.PutUint32",
	"([]byte, uint64) ()":                                                                         "encoding/binary.ByteOrder.PutUint64",
	"([]byte) (uint16)":                                                                           "encoding/binary.ByteOrder.Uint16",
	"([]byte) (uint32)":                                                                           "encoding/binary.ByteOrder.Uint32",
	"([]byte) (uint64)":                                                                           "encoding/binary.ByteOrder.Uint64",
	"(int) (database/sql/driver.ValueConverter)":                                                  "database/sql/driver.ColumnConverter.ColumnConverter",
	"(string) (database/sql/driver.Stmt, error)":                                                  "database/sql/driver.Conn.Prepare",
	"(string) (database/sql/driver.Conn, error)":                                                  "database/sql/driver.Driver.Open",
	"(string, []database/sql/driver.Value) (database/sql/driver.Result, error)":                   "database/sql/driver.Execer.Exec",
	"(string, []database/sql/driver.Value) (database/sql/driver.Rows, error)":                     "database/sql/driver.Queryer.Query",
	"([]database/sql/driver.Value) (error)":                                                       "database/sql/driver.Rows.Next",
	"([]database/sql/driver.Value) (database/sql/driver.Result, error)":                           "database/sql/driver.Stmt.Exec",
	"([]database/sql/driver.Value) (database/sql/driver.Rows, error)":                             "database/sql/driver.Stmt.Query",
	"(interface{}) (database/sql/driver.Value, error)":                                            "database/sql/driver.ValueConverter.ConvertValue",
	"(*text/template/parse.lexer) (text/template/parse.stateFn)":                                  "text/template/parse.stateFn",
}
