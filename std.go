...
var ifaces = map[string]string{
	...
	"Close() error; LocalAddr() net.Addr; Read([]byte) (int, error); RemoteAddr() net.Addr; SetDeadline(time.Time) error; SetReadDeadline(time.Time) error; SetWriteDeadline(time.Time) error; Write([]byte) (int, error)":    "net.dnsConn",
	...
	"Error([]interface{}); Errorf(string, []interface{}); Fail(); FailNow(); Failed() bool; Fatal([]interface{}); Fatalf(string, []interface{}); Log([]interface{}); Logf(string, []interface{}); Skip([]interface{}); SkipNow(); Skipf(string, []interface{}); Skipped() bool": "testing.TB",
	...
	"Exported() bool; Id() string; Name() string; Parent() *go/types.Scope; Pkg() *go/types.Package; Pos() go/token.Pos; String() string; Type() go/types.Type": "go/types.Object",
